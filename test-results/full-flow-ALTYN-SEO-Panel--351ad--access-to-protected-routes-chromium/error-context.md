...
- Name: full-flow.spec.ts >> ALTYN SEO Panel - Full E2E Flow >> should prevent unauthorized access to protected routes
- Location: e2e/full-flow.spec.ts:61:3
...
Received string:  "http://localhost:3000/articles"
Timeout: 10000ms

Call log:
  - Expect "toHaveURL" with timeout 10000ms
    14 × unexpected value "http://localhost:3000/articles"
